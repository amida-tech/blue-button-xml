...
describe('processor', function () {
    it('basic', function () {
        ...
        expect(r.data.t[3]).to.equal("2012-09-15T21:00:00.000Z");
        expect(r.data.t[4]).to.equal("2012-09-15T21:22:00.000Z");
        expect(r.data.t[5]).to.equal("2012-09-15T21:22:15.000Z");
        expect(r.data.t[6]).to.equal("2012-09-15T21:22:15.123Z");
        ...
        expect(r.data.p[6]).to.equal("subsecond");
